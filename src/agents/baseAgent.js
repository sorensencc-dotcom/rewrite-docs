import { callModel, ModelRouter } from "../core/modelRouter.js";
...
export class BaseAgent {
    ...
    formatMessagesForModel(messages, spec) {
        let result = [...messages];
    ...
    stripToolCallInstructions(messages) {
    ...
    normalizeSystemPrompts(messages, spec) {
    ...
    normalizeMessageRoles(messages, spec) {
