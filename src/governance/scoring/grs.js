 ...
 */
export function computeGRS(inputs, config) {
 ...
 */
export function validateGRSInputs(inputs) {
 ...
 */
export function computeAdaptiveRetryCap(grs, config) {
 ...
 */
export function computeRollbackSeverity(grs) {
    if (grs < 0.33)
        return "rollback_soft";
    if (grs < 0.66)
        return "rollback_structured";
