import { GovernanceVaultRecord24_5Schema, VaultRecordBaseSchema, BuildMetadataSchema, } from "./schema";
describe("Governance Vault Schemas", () => {
    ...
    describe("GovernanceVaultRecord24_5Schema", () => {
        it("validates complete record", () => {
            ...
            expect(() => GovernanceVaultRecord24_5Schema.parse(complete)).not.toThrow();
        });
        it("rejects record with invalid decision", () => {
            ...
            expect(() => GovernanceVaultRecord24_5Schema.parse(invalid)).toThrow();
        });
    });
});
