...
export function createContributeCommand(manifestService, db) {
    if (!db) {
        return new Command("contribute")
            .description("Create PR from detected changes")
            .argument("<skill-id>")
            .action(() => {
            console.error("❌ Database not initialized. Cannot create contributions.");
...
//# sourceMappingURL=skill-contribute.js.map