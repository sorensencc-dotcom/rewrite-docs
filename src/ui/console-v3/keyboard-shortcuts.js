 ...
 */
export function parseKeyboardShortcut(event) {
 ...
 */
export function parsePipelineNumber(baseAction, event) {
...
export function installKeyboardHook(callbacks, options) {
 ...
 */
export function getKeyboardReference() {
    const lines = [
