...
describe("Integration Tests", () => {
  ...
  let tempDir: string;
  let mockRouter: any;
  let mockAdapters: Record<string, any>;
  ...
  beforeEach(async () => {
    ...
    mockRouter = {
      invoke: async (adapterId: string, payload: any) => {
  ...
  describe("Provider Adapter Registration", () => {
    ...
    it("should set policies per adapter", async () => {
      ...
      hook.registerProviderAdapter(
        "analytics-adapter",
        mockAdapters["analytics-adapter"],
        CachePolicy.ALWAYS
      );
