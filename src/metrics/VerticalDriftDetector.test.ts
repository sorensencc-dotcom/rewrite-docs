import { VerticalDriftDetector, VerticalMetrics } from "./VerticalDriftDetector"

describe("VerticalDriftDetector", () => {
  let detector: VerticalDriftDetector

  const baselineMetrics: VerticalMetrics = {
    vertical: "dental",
    successCount: 92,
    failureCount: 8,
    timeoutCount: 3,
  ...
  const currentMetrics: VerticalMetrics = {
    vertical: "dental",
    successCount: 75,
    failureCount: 25,
    timeoutCount: 12,
  ...
  describe("detectDrift", () => {
    ...
    it("returns null for improvement", async () => {
      const improvedMetrics: VerticalMetrics = {
        ...baselineMetrics,
        successCount: 97,
        failureCount: 3,
        totalAttempts: 100
    ...
    it("returns null for minimal drift", async () => {
      const minimalDriftMetrics: VerticalMetrics = {
        ...baselineMetrics,
        successCount: 90,
        failureCount: 10,
        totalAttempts: 100
    ...
    it("detects transient error drift", async () => {
      const transientDriftMetrics: VerticalMetrics = {
        ...baselineMetrics,
        successCount: 75,
        failureCount: 25,
        timeoutCount: 15,
    ...
    it("detects structural drift (node count)", async () => {
      const structuralDriftMetrics: VerticalMetrics = {
        ...baselineMetrics,
        successCount: 80,
        failureCount: 20,
        totalAttempts: 100,
    ...
    it("classifies as critical severity for 20%+ drift", async () => {
      const severeDriftMetrics: VerticalMetrics = {
        ...baselineMetrics,
        successCount: 60,
        failureCount: 40,
        totalAttempts: 100,
  ...
  describe("severity mapping", () => {
    it("maps critical severity for high drift", async () => {
      const criticalMetrics: VerticalMetrics = {
        ...baselineMetrics,
        successCount: 50,
        failureCount: 50,
        totalAttempts: 100,
    ...
    it("maps warning severity for hydration drift 10-20%", async () => {
      const warningMetrics: VerticalMetrics = {
        ...baselineMetrics,
        successCount: 80,
        failureCount: 20,
        totalAttempts: 100,
