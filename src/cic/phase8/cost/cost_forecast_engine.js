...
export class CostForecastEngine {
    costModel;
    anomalyThreshold;
    constructor(costModel, anomalyThreshold = 0.75 // 75th percentile triggers anomaly
    ) {
    ...
    calculateAnomalyScore(hourlySpend, recentFiveMinSpend) {
