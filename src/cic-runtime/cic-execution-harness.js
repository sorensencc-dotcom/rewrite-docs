 ...
 */
export async function provisionSandboxEnvironment(tier, modelId) {
 ...
 * S2/S3 are stubbed for Phase Sandbox‑1.
 */
export async function executeInSandbox(env, input) {
 ...
 */
function buildTelemetrySnapshot(req, route, exec) {
    return {
        sloCompliance: {
            latency: true,
            isolation: true,
 ...
 */
export async function runCICExecutionHarness(req, input) {
...
//# sourceMappingURL=cic-execution-harness.js.map