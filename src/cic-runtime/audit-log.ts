 ...
 */
export function initAuditLogPostgres(client: any): void {
  pgClient = client;
}
 ...
 */
function toAuditLogRecord(manifest: RunManifest): AuditLogRecord {
  return {
 ...
 */
export async function ingestRunManifest(manifest: RunManifest): Promise<void> {
