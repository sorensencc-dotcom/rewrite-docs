 ...
 */
export async function executeS3(env, input) {
    ...
    `;
        ...
        fs.writeFileSync(path.join(vmDir, "exec.sh"), `#!/bin/sh\nnode -e '${escapeForShell(input.code)}'`, "utf8");
...
//# sourceMappingURL=s3-exec-firecracker.js.map