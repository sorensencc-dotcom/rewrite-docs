 ...
 */
import { getRoutingSignals, getAllRoutingSignals } from '../routingCostSignals';
describe('RoutingCostSignals', () => {
    // Mock report generator
    const mockReport = (agentCostPerDay, agentSavingsPerDay, agent = 'test-agent') => ({
...
//# sourceMappingURL=routingCostSignals.test.js.map