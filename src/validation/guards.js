 ...
 */
export function validateFinalUrl(url) {
...
export function validatePng(base64) {
...
export function validateScreenshotSize(base64) {
    if (!base64)
...
export function validateJsonCompleteness(json) {
...
export function detectCrashInLogs(logs) {
    if (!Array.isArray(logs))
        return false;
    return logs.some(log => log.includes('Target closed') || log.includes('Protocol error'));
}
