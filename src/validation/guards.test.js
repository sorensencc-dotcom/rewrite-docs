...
import { validateFinalUrl, validatePng, validateScreenshotSize, sanitizeText, validateTextLength, validateJsonCompleteness, detectCrashInLogs, } from './guards';
describe('Guard Helpers', () => {
    ...
    describe('validateFinalUrl', () => {
        ...
        it('returns false for null', () => {
            expect(validateFinalUrl(null)).toBe(false);
        });
        it('returns false for undefined', () => {
            expect(validateFinalUrl(undefined)).toBe(false);
        });
