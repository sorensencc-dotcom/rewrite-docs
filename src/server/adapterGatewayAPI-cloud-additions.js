...
export async function dispatchToCloud(providerName, req) {
...
export function handleCloudDispatch(req) {
...
export function handleGetModels(allowCloud) {
    const offlineModels = [
...
export async function handleHealth(allowCloud) {
    const health = {
        status: "ok",
        providers: {
...
//# sourceMappingURL=adapterGatewayAPI-cloud-additions.js.map