...
describe('LineageRegistry', () => {
    ...
    describe('recordArtifact', () => {
        it('should record artifact with correct fields', () => {
            const record = registry.recordArtifact('agent-1', ['input1', 'input2'], ['output1'], provenance, 'build-001');
    ...
    describe('validateProvenance', () => {
        ...
        it('should reject missing git_sha', () => {
            const record = registry.recordArtifact('agent-1', [], [], { ...provenance, git_sha: '' }, 'build-001');
...
//# sourceMappingURL=lineage-registry.test.js.map