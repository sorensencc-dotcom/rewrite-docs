...
export type SymptomType = 'execTimeExceeded' | 'noOutput' | 'noHeartbeat' | 'oom' | 'gpuOom' | 'dependencyConflict' | 'lockContention' | 'driftSignature';
...
export type OrchestratorState = 'RUNNING' | 'DETECTING' | 'CLASSIFYING' | 'ATTEMPTING_REPAIR' | 'VALIDATING' | 'COOLDOWN' | 'ESCALATING' | 'MANUAL_INTERVENTION';
