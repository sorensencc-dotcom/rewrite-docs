 ...
 */
export function renderUsageCost7dSvg(data) {
    const width = 400;
    const height = 120;
    const padding = 20;
 ...
 */
export function renderLocalSavings7dSvg(data) {
    const width = 400;
    const height = 120;
    const padding = 20;
    const innerWidth = width - 2 * padding;
 ...
 */
export function renderPerModelCostSvg(models) {
    const width = 400;
    const height = 120;
    const padding = 20;
    const innerWidth = width - 2 * padding;
...
//# sourceMappingURL=CostCharts.js.map