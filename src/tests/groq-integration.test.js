...
describe("Groq Provider Integration", () => {
    ...
    it("should throw on missing API key (non-test mode)", async () => {
        ...
        await expect(groqProvider.chat(req)).rejects.toThrow("GROQ_API_KEY required");
    ...
    it("should throw on invalid model", async () => {
        ...
        await expect(groqProvider.chat(req)).rejects.toThrow("Model not found");
    });
...
//# sourceMappingURL=groq-integration.test.js.map