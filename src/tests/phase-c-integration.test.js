...
describe("Phase C: Integration (A + B)", () => {
    let hardeningRegistry;
    let circuitBreakerRegistry;
    let rateLimiterRegistry;
    ...
    beforeEach(() => {
        ...
        metricsCollector = new ResilientMetricsCollector(hardeningRegistry, circuitBreakerRegistry, rateLimiterRegistry);
    });
    ...
    describe("Phase D: Fallback Metrics", () => {
        ...
        it("should track fallback provider states in metrics", async () => {
            ...
            orch.addFallbackProvider("stable-fb", async () => "ok", 1);
...
//# sourceMappingURL=phase-c-integration.test.js.map