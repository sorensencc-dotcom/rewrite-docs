...
import { FallbackChain } from "../resilience/fallbackChain.js";
...
describe("Phase B: Hardening", () => {
    ...
    describe("Hardening Orchestrator", () => {
        ...
        it("should apply rate limiting", async () => {
            ...
            await expect(orch.execute(async () => "3")).rejects.toThrow("rate limit exceeded");
        });
        it("should apply timeout", async () => {
            ...
            await expect(orch.execute(async () => {
                await new Promise(r => setTimeout(r, 500));
                return "too slow";
        ...
        it("should invoke fallback chain on primary failure when providers registered", async () => {
            ...
            orch.addFallbackProvider("fallback", async () => "fallback result", 1);
...
//# sourceMappingURL=hardening-phase-b.test.js.map