...
describe("WS-B Validation Runner", () => {
    ...
    test("wsb validation runs all four scenarios", async () => {
        b1.runBurnRateSpikeFireDrill.mockResolvedValue({
            startedAt: Date.now(),
        ...
        b2.runLatencyRegressionGate.mockResolvedValue({
            startedAt: Date.now(),
            completedAt: Date.now() + 1000,
            abortTriggered: true,
            rollbackCompleted: true,
        ...
        b3.runErrorRateDriftGate.mockResolvedValue({
            startedAt: Date.now(),
            completedAt: Date.now() + 1000,
            abortTriggered: true,
            rollbackCompleted: true,
        ...
        b4.runSaturationGate.mockResolvedValue({
            startedAt: Date.now(),
            completedAt: Date.now() + 1000,
            abortTriggered: true,
            rollbackCompleted: true,
...
//# sourceMappingURL=wsb-runner.test.js.map