import { ExecutionMode, ExecutionPolicyEngine, getExecutionPolicyEngine, } from './ExecutionPolicy';
...
describe('ExecutionPolicy', () => {
    ...
    describe('validateContext', () => {
        ...
        it('rejects UNATTENDED without pre-approved tools', () => {
            ...
            const result = engine.validateContext(context);
            expect(result.valid).toBe(false);
            expect(result.errors).toContain('mode UNATTENDED requires at least one preapprovedTool');
        });
...
describe('TaskMetadataStore', () => {
    ...
    describe('audit log export', () => {
        ...
        it('exports all execution histories', () => {
            ...
            expect(parsed.map((p) => p.taskId)).toContain('task-1');
            expect(parsed.map((p) => p.taskId)).toContain('task-2');
        });
    });
    describe('cleanup', () => {
...
//# sourceMappingURL=ExecutionPolicy.test.js.map