...
let fireDrillManager = null;
export function getFireDrillManager() {
    if (!fireDrillManager) {
...
export function createFireDrillRouter() {
    const router = Router();
     ...
     */
    router.post("/firedrills/run", async (req, res) => {
        try {
     ...
     */
    router.get("/firedrills/report", (req, res) => {
     ...
     */
    router.get("/firedrills/health", (req, res) => {
     ...
     */
    router.post("/firedrills/schedule", (req, res) => {
        try {
     ...
     */
    router.post("/firedrills/unschedule", (req, res) => {
        try {
...
//# sourceMappingURL=firedrills.js.map