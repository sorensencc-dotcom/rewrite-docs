...
describe('Memory Router (Phase 5b)', () => {
    ...
    it('should have 6 memory endpoints registered', () => {
        ...
        const routes = memoryRouter.stack.filter((layer) => layer.route);
...
describe('Governance Router (Phase 5b)', () => {
    ...
    it('should have 6 governance endpoints registered', () => {
        ...
        const routes = governanceRouter.stack.filter((layer) => layer.route);
        expect(routes.length).toBe(6);
    });
...
//# sourceMappingURL=memory-governance.test.js.map