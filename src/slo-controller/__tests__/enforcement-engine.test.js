...
describe('EnforcementEngine', () => {
    ...
    beforeEach(() => {
        ...
        // Setup default mocks
        canaryAbort.triggerCanaryAbort.mockResolvedValue(undefined);
        canaryRollback.executeCanaryRollback.mockResolvedValue({
            success: true,
...
//# sourceMappingURL=enforcement-engine.test.js.map